...
const CreateCardNewScreen = () => {
  ...
  const [modalNetwork, setModalNetwork] = useState<"telegram" | "instagram" | "twitter" | "linkedin" | "facebook" | null>(null);
        ...
        >
          <View style={styles.cardContainer}>
                ...
                <View style={styles.locationContentColumn}>
                  <TextInput
                    style={[
                      styles.input,
                      styles.nickname,
                      { color: colors.text, borderColor: colors.border, textAlign: 'left', height: 40, alignItems: 'center' }]}
                    value={formData.location.country}
                    onChangeText={(value) => handleInputChange("location.country", value)}
            ...
            >
              ...
              <View>
                <TextInput
                  style={[styles.input, styles.name, { color: colors.text, borderColor: colors.border, textAlign: 'center' }]}
                  value={formData.name}
                  onChangeText={(value) => handleInputChange("name", value)}
              ...
              <View style={styles.descriptionSection}>
                <TextInput
                  style={[
                    styles.input,
                    styles.description,
                    { color: colors.text, borderColor: colors.border, textAlign: 'left', alignItems: 'center', height: 60, textAlignVertical: 'top' }]}
                  value={formData.bio}
                  multiline
                  numberOfLines={4}
                  onChangeText={(value) => handleInputChange("bio", value)}
              ...
              <View style={styles.socialIconsContainer}>
                {socialIcons.map((icon, index) => (
                  <TouchableOpacity
                    ...
                    key={index}
                    style={[styles.socialIcon, { borderWidth: 1, borderColor: '#9B9B9B' }]}
                  >
                    {icon.name}
                  </TouchableOpacity>
                ))}
...
const YellowCrownIcon = () => (
  ...
  >
    <Path
      d="M9.74902 0C9.8785 7.38348e-06 10.0065 0.0338689 10.1191 0.0976562C10.2317 0.161435 10.326 0.25336 10.3926 0.364258L13.6045 5.7002L18.3418 2.62109C18.4628 2.5426 18.6038 2.50032 18.748 2.5C18.8923 2.49973 19.0339 2.54112 19.1553 2.61914C19.2766 2.69724 19.373 2.809 19.4326 2.94043C19.4922 3.07197 19.5126 3.2185 19.4912 3.36133L17.9912 13.3613C17.9645 13.5389 17.8753 13.7012 17.7393 13.8184C17.6031 13.9356 17.4287 14.0001 17.249 14H2.24902C2.06948 14 1.89583 13.9355 1.75977 13.8184C1.62369 13.7012 1.53449 13.5389 1.50781 13.3613L0.0078125 3.36133C-0.0135291 3.2185 0.00681756 3.07197 0.0664062 2.94043C0.126005 2.80902 0.222401 2.69723 0.34375 2.61914C0.465105 2.54116 0.606718 2.49973 0.750977 2.5C0.895234 2.50034 1.0362 2.54259 1.15723 2.62109L5.89453 5.7002L9.10645 0.363281C9.17317 0.252506 9.26729 0.160283 9.37988 0.0966797C9.49243 0.0331427 9.61979 -2.21912e-05 9.74902 0Z"
      fill="#FFC300"
    />
  </Svg>
);
