...
const EditCardScreen = () => {
  ...
  const handleEditCard = (card: Card) => {
    // Navigate to edit form with card data
    // For now, we'll show an alert with card info
    Alert.alert("Edit Card", `Edit functionality for ${card.name} will be implemented here.`, [
      {
        text: "Cancel",
        style: "cancel",
      },
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Select a card to edit its information</Text>
